...
$database = new CreateDb("webshop", "liquor");
...
if (isset($_POST['add'])){
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['productid'], $item_array_id)){
            echo "<script>window.location = 'liquor.php'</script>";
        }else{
    ...
    <div class="container-fluid lablec">
        <div class="lablecBrand d-flex pt-4">
            ...
            <div class="mx-5 align-self-center" style="text-align: left;">
                ...
                <br>
                <i class="far fa-envelope" style="color: rgb(165, 165, 165);"></i> gigga@nigga.com
            </div>
        </div>
        <hr>
