...
function mouseOver(){
    ...
    const name = document.forms['suForm']['teljesnev'].value;
    ...
    if((name == "" || pass == "" || loc == "" || koz == "" || haz == "" || phone == "") && a==0){
    buttonMoveLeft();
    a = 1;
    return false;
    } 

    if((name == ""  || pass == "" || loc == "" || koz == "" || haz == "" || phone == "") && a==1){
    buttonMoveRight();
    a = 2;
    return false;
    } 

    if((name == "" || pass == "" || loc == "" || koz == "" || haz == "" || phone == "") && a==2){
    buttonMoveLeft();
    a = 1;
    return false;
    } 
