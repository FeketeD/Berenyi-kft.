...
$database = new CreateDb("webshop", "vodka");
...
if (isset($_POST['add'])){
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['productid'], $item_array_id)){
            echo "<script>window.location = 'vodka.php'</script>";
        }else{
        ...
        <div class="container-fluid navig">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link vis" href="#">Sör, Cider</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item vis" href="#">Vodka</a></li>
                            <li><a class="dropdown-item vis" href="#">Bor</a></li>
                            <li><a class="dropdown-item vis" href="#">Rum</a></li>
                            <li><a class="dropdown-item vis" href="#">Likőr, Krémlikőr</a></li>
                            <li><a class="dropdown-item vis" href="#">Pezsgő</a></li>
