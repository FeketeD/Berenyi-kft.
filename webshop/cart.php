                        ...
                        if (isset($_SESSION['cart'])){
                            ...
                            while ($row = mysqli_fetch_assoc($result)){
                                foreach ($product_id as $id){
                                    if ($row['id'] == $id){
                                        cartElement($row['product_image'], $row['product_name'], $row['product_description'],$row['product_price'], $row['id']);
                        ...
                        <div class="col-md-6">
                            <?php
                                if (isset($_SESSION['cart'])){
                                    ...
                                    echo "<h6>Fizetendő (0 db termék)</h6>";
                                }
                            ?>
        ...
        <div class="form-nyit" id="myForm">
            <div class="py-1 px-1">
                ...
                <form action="/action_cart.php" class = "form-container">
                    <div class="orderForm py-3 mt-5 text-center">
                            <div class="w-100 ra">
                        ...
                        <br>
                        <input class="mb-2" type="text" placeholder="Teljes Név" name="teljesnev" style="width: 40%" required>
                        <br>
                        <label for="telepules"><b>Település:</b></label>
                        <br>
                        <input class="mb-2"type="text" placeholder="Település" name="telep" style="width: 40%" required>
                        <br>
                        <label for="iranyitoszam"><b>Iráyítószám:</b></label>
                        <br>
                        <input class="mb-2" type="text" placeholder="Irányítószám" name="irszam" style="width: 20%" required>
                        <br>
                        <label for="koznev"><b>Közterület neve:</b></label>
                        <br>
                        <input class="mb-2" type="text" placeholder="Közterület neve" name="kozter" style="width: 40%" required>
                        <br>
                        <label for="koznev"><b>Házszám, Emelet/ajtó:</b></label>
                        <br>
                        <input class="mb-2" type="int" placeholder="pl.: 6, 4/2" name="" style="width: 40%" required>
                        <br>
                        <label for="telefonszam"><b>Telefonszám:</b></label>
                        <br>
                        <input class="mb-2" type="text" placeholder="pl.: +36204206969" name="telefon" style="width: 40%" required>
                        <br>
                        <label for="email"><b>E-mail cím:</b></label>
                        <br>
                        <input class="mb-2" type="text" placeholder="pl.: alkoholista@allat.hu" name="mail" style="width: 40%" required>
                        <br>
                        <label for="fizetes"><b>Fizetési mód:</b></label>
                        <br>
                        <select class="w-25 mb-2" name="pay" required>
