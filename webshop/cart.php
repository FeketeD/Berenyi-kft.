...
<body class="bg-light">
            ...
            <div class="container-fluid navig">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link vis" href="alcoholfree.php">Alkoholmentes italok</a>
                        </li>
                    </ul>
                </div>
                        ...
                        if (isset($_SESSION['cart'])){
                            ...
                            while ($row = mysqli_fetch_assoc($result)){
                                foreach ($product_id as $id){
                                    if ($row['productid'] == $id){
                                        cartElement($row['productimg'], $row['productname'], $row['productsd'],$row['productprice'], $row['productid']);
                        ...
                        <div class="col-md-6">
                            ...
                            <h6 class="" id = "delivery-fee"><?php
                                if($total == 0 || $total > 30000) {
                                    ...
                                    echo '<font color = "red">1500 Ft</font>';
                                }?>
                            </h6>
                            <hr>
                            <h6><?php
    ...
    <div class="overlay" id="myOverlay">
        <div class="form-nyit" id="myForm">
            <div class="py-1 px-1">
                &nbsp
                <form action="rendel.html" class="form-container" name="suForm" id="supform">
                    <div class="orderForm py-3 mt-5">
                        ...
                        <br>
                        <input class="mb-3" type="text" placeholder="Teljes Név" name="teljesnev" style="width: 40%" onclick="resetBtn()" required>
                        <br>
                        <label for="telepules"><b>Település:</b></label>
                        <br>
                        <input class="mb-3"type="text" placeholder="Település" name="telep" style="width: 40%" onclick="resetBtn()" required>
                        <br>
                        ...
                        <br>
                        <input class="mb-3" type="text" placeholder="Közterület neve" name="kozter" style="width: 40%" onclick="resetBtn()" required>
                        <br>
                        <label for="koznev"><b>Házszám, Emelet/ajtó:</b></label>
                        <br>
                        <input class="mb-3" type="int" placeholder="pl.: 6, 4/2" name="hSzam" style="width: 40%" onclick="resetBtn()" required>
                        <br>
                        <label for="telefonszam"><b>Telefonszám:</b></label>
                        <br>
                        <input class="mb-3" type="text" placeholder="pl.: +36204206969" name="telefon" style="width: 40%" onclick="resetBtn()" required>
                        <br>
                        ...
                        <br>
                        <select class="w-25 mb-3" name="pay">
                        ...
                        <br>
                        <button class="btn btn-success btn-order" onclick="orderFinish()" id="submit-btn" name="rendel" onmouseover="rendeles()">Rendelés leadás</button>
                        <?php
